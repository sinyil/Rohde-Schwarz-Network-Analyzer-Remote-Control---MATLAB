...
% VISA_Instrument This class defines instrument remote-control connection over VISA.NET. Version 1.5.0
    ...
    methods
        ...
        function Write(obj, command, varargin)
            ...
            elseif (arguments == 6)
                ...
                throw(MException('VISA_Instrument:formatting into string','Only up to 6 format parameters are supported'));
            end
